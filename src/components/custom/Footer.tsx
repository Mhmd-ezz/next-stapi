...
function selectSocialIcon(url: string) {
  ...
  if (url.includes("facebook")) return <TwitterIcon className="h-6 w-6" />;
...
function TwitterIcon(props: any) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M22 12.07c0-5.52-4.48-10-10-10S2 6.55 2 12.07c0 4.99 3.66 9.13 8.44 9.88v-6.99H7.9v-2.89h2.54V9.84c0-2.52 1.48-3.91 3.74-3.91 1.08 0 2.21.19 2.21.19v2.43h-1.24c-1.22 0-1.6.76-1.6 1.54v1.86h2.72l-.43 2.89h-2.29v6.99C18.34 21.2 22 17.06 22 12.07z"/>
    </svg>
  );
}
